...
settings = {
    ...
    "message":"บัญชีนี้ถูกป้องกันโดยแนน ระบบได้ทำการบล็อคคุณอัตโนมัติ!..",
    "comment":"""""",
    "userAgent": [
...
#==============================================================================#
                    ...
                    start = time.time()
                    line.sendMessage(to, "ความเร็ว แนน ...")
...
#===========
                    ...
                    line.sendMessage(to,"แนนยังคงป้องกันห้อง100%")       
#==============================================================================#
        ...
        if op.type == 26:
            ...
            if settings ["Api"] == True:
                if msg.text in ["55","555","5555","55555","55+","555+","5555+","ขำ","ขำๆ"]:
                    line.sendText(msg.to,"อย่ามาขำเดี่ยวกตบล่วงอีสัส🙄😎🤔")
.to, str(settings["comment"]))
            if settings ["Api"] == True:
                if msg.text in ["เงิน","ง","🔵"]:
                    line.sendText(msg.to,"สวนแทงแดง100%")
.to, str(settings["comment"]))
            if settings ["Api"] == True:
                if msg.text in ["แดง""ด"]:
                    line.sendText(msg.to,"สวนเงินสิสัสรอไร
            if settings ["Api"] == True:
